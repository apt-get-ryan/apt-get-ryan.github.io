...
export const StyledButton = ({children, className, variant, href, ...props}) => {
  ...
  const variantClasses = {
    ...
    black: "bg-slate-600 border-slate-700 text-white",
    default: "bg-stone-500 border-stone-600 text-white"
  }
  dynamicStyles = variantClasses[variant] || variantClasses["default"];
